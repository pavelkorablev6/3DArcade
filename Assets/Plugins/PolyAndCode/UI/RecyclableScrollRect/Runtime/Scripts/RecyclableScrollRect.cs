...
namespace PolyAndCode.UI
{
    ...
    public sealed class RecyclableScrollRect : ScrollRect
    {
        ...
        private void Initialize()
        {
            ...
            _ = StartCoroutine(_recyclingSystem.InitCoroutine(() => onValueChanged.AddListener(OnValueChangedListener)));
        }
        ...
        /// </summary>
        public void ReloadData() => ReloadData(DataSource);
        ...
        public void ReloadData(IRecyclableScrollRectDataSource dataSource)
        {
            if (_recyclingSystem != null)
            {
                ...
                _ = StartCoroutine(_recyclingSystem.InitCoroutine(() =>
